					...
					<div class="block">
						<div class="verh">
							<div class="fw middle">
								...
								<div class="cc30">
									<img src="assets/img/sale/finntrail WADEMAN mini sale.jpg" alt="">
								</div>
								<div class="cc35">
						...
						<div class="niz">
							...
							<p class="name mb1"><strong>Finntrail </strong>WADEMAN 1524</p>
							<div class="price">
								<p class="discount dib">-40%</p>
								<p class="del">13 320</p>
								<p class="new dib">7 990.-</p>
							</div>
							<div class="tac mt1">
					...
					<div class="block">
						<div class="verh">
							<div class="fw middle">
								...
								<div class="cc30">
									<img src="assets/img/sale/FINNTRAIL AQUABAG mini SALE.jpg" alt="">
								</div>
								<div class="cc35">
									<p class="mt2">Finntrail</p>
					...
					<div class="block">
						<div class="verh">
							<div class="fw middle">
								...
								<div class="cc30">
									<img src="assets/img/sale/Finntrail Mud Rider mini SALE.jpg" alt="">
								</div>
								<div class="cc35">
									<p class="mt2">Finntrail</p>
			...
			<div id="content">
				<div id="veiders">
					...
					<div class="product block">
						...
						<div class="block tar">
							<p>Finntrail</p>
							<img class="mt9" src="assets/img/minilogo.png" alt="">
						</div>
						<div class="info tac">
							<p><span>вейдерсы</span><br><strong>Finntrail </strong>ENDURO</p>
							<p class="dib old mt2">15 990</p>
							<p class="dib new mt2">14 520.-</p>
							<div class="mt1">
								<a href="#x" class="btn">ЗАКАЗАТЬ</a>
							</div>
						</div>
						<a href="#x" title="">
							<div class="overlay tac" onclick="popup(1,this)">
			...
			<div class="border mt5">
				<div class="fw">
					...
					<div class="cc60 text mt5 pc5">
						...
						<p class="mt1">Мы пришлём Вам<strong> несколько вариантов</strong><br>и Вы сможете <strong>примерить</strong> их до покупки<strong> 275 городах РФ!</strong></p>	
...
<script>
	...
	tovar_katalog = [
	{
		  kartinka: 'assets/img/popupveiders.jpg'
		, name: '<strong>FINNTRAIL</strong> ATHLETIC PLUS 1522 (RED)1'
		, about: 'Вейдерсы для квадроцикла'
		, li: [
					  '<li>Износостойкая мембранная<br> ткань HARD-TEX</li>'
					+ '<li>Четыре слоя мембраны</li>'
		...
		, cena: '10 490.-'
		, cena_visit2: '12 490.-'
		, opisanie: 'Вейдерсы для тех, кто ценит <strong>комфорт</strong> и надёжное сцепление на пересечённой местности. Классическая модель слитная с <strong>неопреновыми носками</strong> и <strong>усиленной тканью</strong> на коленях и седалище. В этой модели используется специальная износостойкая четырёхслойная ткань с мембраной <strong>«HARD-TEX»</strong>.<br>Вейдерсы <strong>не имеют швов</strong> во внутренней части, таким образом, увеличена долговечность и износостойкость. В этой модели использованы все технологии, обеспечивающие <strong>долгий срок службы и комфорт</strong>.'
		, opisanie_li: [
			  '<li>Износостойкая 4-х слойная ткань с мембраной «HARD-TEX»</li>'
			+ '<li>Высокая водонепроницаемость 20 000 мм</li>'
			+ '<li>Дышащая способность 7000г./м2/24ч</li>'
		...
		,  kartinki:
			'<img src="assets/img/popuptrigger1.png" alt="" align="bottom">'
	      	+ '<img src="assets/img/popuptrigger2.png" alt="" align="bottom">'
	    , foto: '<img src="assets/img/popupveiders.jpg" alt="" align="bottom">'
	},
	/* товар 2 */
	{
		  kartinka: 'assets/img/popupveiders.jpg'
		, name: '<strong>FINNTRAIL</strong> ATHLETIC PLUS 1522 (RED)'
		, about: 'Вейдерсы для квадроцикла'
		, li: [
					  '<li>Износостойкая мембранная<br> ткань HARD-TEX</li>'
					+ '<li>Четыре слоя мембраны</li>'
